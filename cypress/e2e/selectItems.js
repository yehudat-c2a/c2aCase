class selectItems
{
    ...
    #selectors = {
        ...
        nextBtn:() =>{return cy.get(this.#ids.nextBtn)
        },
...
async #enterCheapest ()
{   //i tryed to do search in all the pages, but i had problems and hadn't enough time to fix it, so i search for cheapest and most expensive products only in the first page
